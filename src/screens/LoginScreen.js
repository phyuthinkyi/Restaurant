    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ flex: 1, padding: 18, justifyContent: 'center', alignItems: 'center' }}>
        <View style={{ width: '100%' }}>
          ...
          <TouchableOpacity onPress={() => loginHandle()} style={{ marginTop: 10, height: 50, borderRadius: 5, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.primaryColor }}>
